...
SEC_USED(.fft_data) static int datain[MAX_FFT_SUPPORT_POINT_NUM];
SEC_USED(.fft_data) static int datain_y[MAX_FFT_SUPPORT_POINT_NUM];
SEC_USED(.fft_data) static int dataout[MAX_FFT_SUPPORT_POINT_NUM + 2];
#else
#if defined CONFIG_VIDEO_ENABLE
SEC_USED(.fft_data) static int datain[MAX_FFT_SUPPORT_POINT_NUM + 2];
