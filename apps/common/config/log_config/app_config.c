...
/******************************************************************/
const char log_tag_const_v_ONLINE_DB AT(.LOG_TAG_CONST) = FALSE;
const char log_tag_const_i_ONLINE_DB AT(.LOG_TAG_CONST) = FALSE;
const char log_tag_const_d_ONLINE_DB AT(.LOG_TAG_CONST) = FALSE;
const char log_tag_const_w_ONLINE_DB AT(.LOG_TAG_CONST) = FALSE;
const char log_tag_const_e_ONLINE_DB AT(.LOG_TAG_CONST) = TRUE;
