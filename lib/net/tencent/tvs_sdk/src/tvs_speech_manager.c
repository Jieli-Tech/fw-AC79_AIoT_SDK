                             ...
                             bool *connected)
{
    ...
    bool use_speex = true;
#endif
    char *payload = get_speech_recognize_request_body(use_speex, bitrate == 8000, speech_param.dialog_id,                    speech_config->type, speech_config->wakeword, speech_config->startIndexInSamples, speech_config->endIndexInSamples);
